package emperorfin.android.dummyjsonusers.domain.uilayer.event.output

import emperorfin.android.dummyjsonusers.domain.exception.Failure
import emperorfin.android.dummyjsonusers.domain.uilayer.event.output.ResultData.Success
